...
<div class="modal" class:modal-open={isModal}>
    <form method="dialog" class="modal-box max-w-none w-1/2">
        ...
        <div class="form-control w-full my-3">
            ...
            <input type="text" placeholder="Cth: KOSADA/2022/10/16-20:21" class="input input-bordered w-full" />
        </div>
        ...
        <div class="form-control w-full my-3">
            ...
            <input type="text" placeholder="Cth: Bukti Pembayaran (2 Lembar)" class="input input-bordered w-full" />
        </div>
        ...
        <div class="form-control w-full my-3">
            ...
            <input type="text" placeholder="Cth: Penagihan Pembayaran" class="input input-bordered w-full" />
        </div>
        ...
        <div class="form-control w-full my-3">
            ...
            <textarea class="textarea textarea-bordered" placeholder="Isi Surat" rows="5"></textarea>
        </div>
