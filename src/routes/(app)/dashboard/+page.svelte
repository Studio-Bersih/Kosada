...
<div class="container mx-auto my-5">
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            ...
            <!-- A grid, not flex justify-between: the old layout spread five items
                 of different widths across the row and stranded the submit button's
            ...
            <form on:submit|preventDefault={applyFilters}
                ...
                <div class="form-control">
                    ...
                    <MarketingSelect bind:value={form.kategori} includeSemua class="select select-bordered w-full" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="startDate" type="date" bind:value={form.date.start} class="input input-bordered w-full"/>
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="endDate" type="date" bind:value={form.date.end} class="input input-bordered w-full"/>
                </div>
            ...
            <div class="overflow-x-auto my-5 max-h-[70vh]">
                        ...
                        {#each modalData.DETAIL as detail, index }
                            <tr class="hover">
                                <td>
                                    ...
                                    {:else}
                                        <span class="badge badge-success badge-sm w-full">Lunas</span>
                                    {/if}
                                </td>
